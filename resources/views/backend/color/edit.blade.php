                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('color.update', $color->id)}}" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="firstName" value="{{$color->name}}" name="name" placeholder="Unit Name" type="text">
                            </div>
                            <div class="row mb-4">
                                <label for="firstCode" class="col-md-3 form-label">Unit Code</label>
                                <div class="col-md-9">
                                    <input class="form-control" id="firstCode" value="{{$color->code}}" name="code" placeholder="Unit Code" type="code">
                                </div>
                            </div>
                            <div class="row mb-4">
