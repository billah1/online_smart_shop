    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="deal" style="background-image: url('{{asset('/')}}frontend/assets/imgs/banner/menu-banner-7.png')">
                    <div class="deal-top">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="shopping-cart-title">
                                                ...
                                                <h4><span>{{$cartItem->qty}}× </span>Tk.{{$cartItem->price}}</h4>
                                            </div>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index-2.html"><img src="{{asset('/')}}frontend/assets/imgs/theme/logo.svg" alt="logo"></a>
                </div>
